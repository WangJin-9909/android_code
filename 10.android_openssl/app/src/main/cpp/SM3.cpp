...
void CSM3::SM3_Update(BYTE * message, DWORD length)
{
...
void CSM3::SM3_Final_dword(DWORD * out_hash)
{
	DWORD i;
...
void CSM3::SM3_Final_byte(BYTE * out_hash)
{
	int i = 0;
	DWORD hash[8] = {0};
...
void CSM3::SM3_Final(DWORD * out_hash)
{
